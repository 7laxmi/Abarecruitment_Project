    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        ...
        <form>
                <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                    ...
                    focus-within:ring-2 ficus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                    ...
                    focus-within:ring-2 ficus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
