                ...
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                    ...
                    <div className='create-job-flex'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="date" placeholder='Ex: 2024-01-05'
                                {...register("postingDate")} className='create-job-input' />
                        </div>
                        <div className='lg:w-1/2 w-full'>
                            <label className='block mb-2 text-lg'>Experiece Level</label>
                            <select {...register("experienceLevel")} className='create-job-input'>
                                <option value="">Choose your experiencel</option>
                    ...
                    <div className='create-job-flex'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="url" placeholder='Paste your company logo url: https://westransfer.com/'
